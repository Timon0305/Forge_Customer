                                    ...
                                    <Col lg={3} md={4}>
                                        <div className="pt-3 text-left m-5">
                                            ...
                                            <div className="mt-1 mb-2">
                                                ...
                                                <br/>
                                                <Nouislider
                                                    range={{ min: 0, max: 10560 }}
                                                    tooltips={true} start={[0, 10560]}
                                                    connect
                                                    animate={true}
                                            ...
                                            <hr/>
                                            <div>
                                                <h5 className='text-white mt-3'>ChipSet</h5>
                                                <div className='filterHidden'>
                                                    {
                                                        vm.chipSet.map((item, index) =>
                                                            <ChipSet
                                                                key={index}
                                                                id={item._id}
                                                                status={item.status}
                                                                name={item.name}
                                                                checked={() => vm.filterChipSet(item.name)}
                                                            />
                                                        )
                                                    }
                                                </div>
...
export const ChipSet = ({id, name, status, checked}) => {
    return (
        <React.Fragment>
            <div className="custom-control custom-checkbox mt-2">
                <Input
...
export const Products = ({id, name, image, chipSet, memory, coreClock, boostClock, color, length, price, addToCart}) => {
    return (
        <React.Fragment>
